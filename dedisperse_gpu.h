...
typedef struct {
    ...
    char *dsbuf_gpu;              // downsampled data (8-bit or 32-bit data)

    // GPU control stuff
    cufftHandle plan;           // CUFFT plan
    cufftHandle plan2;          // CUFFT plan
